...
void komodo_args(char *argv0)
{
    ...
    SoftSetArg("-ac_halving", std::string("1290"));
    SoftSetArg("-ac_decay", std::string("82400000"));
    SoftSetArg("-ac_founders", std::string("1"));
    SoftSetArg("-ac_perc", std::string("1000000"));
    SoftSetArg("-ac_perc", std::string("1000000"));
    SoftSetArg("-ac_end", std::string("2880"));
    SoftSetArg("-ac_cbmaturity", std::string("2880"));
    SoftSetArg("-addnode", std::string("192.168.1.195"));
    SoftSetArg("-ac_pubkey", std::string("022b9c9d89ff99775a62c3f56679dc2d4909bc3b6a7cd8a788dd02c9955a5c11f3"));
